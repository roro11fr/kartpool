...
class WishlistView(viewsets.ModelViewSet):
    ...
    def create(self, request):
        ...
        return Response(
            wishlist_data.data, status=201
        )  # Returnează un status 201 pentru creație reușită
    ...
    def list(self, request):
        ...
        if buyer_id:
            try:
                ...
                options["buyer"] = (
                    buyer  # Filtrează wishlist-urile pentru utilizatorul cu acest ID
                )
    ...
    def my_wishlists(self, request):
        ...
        options["buyer"] = (
            request.user
        )  # Filtrăm pentru wishlist-urile utilizatorului curent
